 ...
 * Allure ScreenShotRobot and SaveTestLog if (getDriver() instanceof WebDriver)
 * { System.out.println("Screenshot captured for test case:" +
 * getTestMethodName(iTestResult)); saveScreenshotPNG(getDriver()); } // Save a
 * log on allure. saveTextLog(getTestMethodName(iTestResult) +
